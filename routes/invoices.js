...
// PUT /[code] => update invoice {amt, paid} => {id, comp_code, amt, paid, add_date, paid_date} If paying unpaid invoice, set paid_date; if marking as unpaid, clear paid_date.
...
// Delete /[code] => delete invoice => {status: 'deleted'}
